		...
		<div className="text-center">
			...
			<main>
				<div>
					<h1>Why Choose Us!</h1>
					<div>
						<p>Autism Aims uses programs that have been proven in studies from the Journal of Applied Behavior Analysis (JABA) to be effective.
						...
						<p>Autism Aims primarily focus on reinforcement techniques.
